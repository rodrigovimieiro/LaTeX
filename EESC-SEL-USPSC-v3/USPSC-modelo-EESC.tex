...
%\siglaunidade{EESC}
\include{USPSC-classe/USPSC-pre-textual-EESC}
...
%\includepdf{chapters/PreTextual/fichacatalografica.pdf}

% Se você optar por elaborar a ficha catalográfica, deverá 
% incluir uma % antes da linha % antes
% do comando \include{USPSC-TA-PreTextual/USPSC-fichacatalografica} 
% e retirar o % do comando abaixo
\include{chapters/PreTextual/fichacatalografica}
...
\include{chapters/PreTextual/Errata}
...
\include{chapters/PreTextual/folhadeaprovacao}
%\includepdf{USPSC-TA-PreTextual/USPSC-PaginaEmBranco.pdf}

% ---
% Dedicatória
% ---
\include{chapters/PreTextual/Dedicatoria}
% ---

% ---
% Agradecimentos
% ---
\include{chapters/PreTextual/Agradecimentos}
% ---

% ---
% Epígrafe
% ---
\include{chapters/PreTextual/Epigrafe}
% ---
...
% Abstract
% ---
\include{chapters/PreTextual/Abstract}
% ---
% resumo em português
%
% Resumo
% ---
\include{chapters/PreTextual/Resumo}
% ---
...
% ---
\include{chapters/PreTextual/Acronyms}
% ---

% ---
% inserir lista de símbolos
% ---
\include{chapters/PreTextual/Simbolos}
% ---
% ---
% inserir o sumario
% ---
...
\include{chapters/Cap1-Introducao}
\include{chapters/Cap2-Desenvolvimento}
\include{chapters/Cap3-Conclusao}
...
% Apêndices
% ----------------------------------------------------------
\include{chapters/PosTextual/Apendices}

% ----------------------------------------------------------
% Anexos
% ----------------------------------------------------------
\include{chapters/PosTextual/Anexos}

%---------------------------------------------------------------------
% INDICE REMISSIVO
%--------------------------------------------------------------------
\include{chapters/PosTextual/IndicesRemissivos}
